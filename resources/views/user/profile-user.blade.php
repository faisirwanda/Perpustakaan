                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input id="class" type="class" class="form-control @error('class') is-invalid @enderror" name="class" value="{{ old('class', $user->class) }}" readonly>
                                    ...
                                    <div class="row mb-0">
                                        <div class="col-md-8 offset-md-4">
                                            <a href="/user/profile-user-edit" class="btn btn-warning text-white"><i class="bi bi-pencil-square"></i> Edit Profil</a>
                                        </div>
                                    </div>
                            </div>
                        </div>
