                      ...
                      <div class="row">
                          ...
                          <div class="col-md-8">
                              <table class="table table-borderless fs-6 mb-0">
                                  <tr>
                                      <th style="width: 120px;" class="text-start">Kode </th>
                                      <td style="width: 12px;" class=" fw-bold">:</td>
                                      <td class="text-start">{{ $book->id }}</td>
                                  </tr>
                                  <tr>
                                      <th style="width: 120px;" class="text-start">Judul </th>
                                      <td style="width: 12px;" class=" fw-bold">:</td>
                                      <td class="text-start">{{ $book->title }}</td>
                                  </tr>
                                  <tr>
                                      <th style="width: 120px;" class="text-start">Kategori</th>
                                      <td style="width: 12px;" class=" fw-bold">:</td>
                                      <td class="text-start">{{ $book->categories->name }}</td>
                                  </tr>
                                  <tr>
                                      <th style="width: 120px;" class="text-start">pengarang</th>
                                      <td style="width: 12px;" class=" fw-bold">:</td>
                                      <td class="text-start">{{ $book->author }}</td>
                                  </tr>
                                  <tr>
                                      <th style="width: 120px;" class="text-start">Penerbit</th>
                                      <td style="width: 12px;" class=" fw-bold">:</td>
                                      <td class="text-start">{{ $book->publisher }}</td>
                                  </tr>
                                  <tr>
                                      <th style="width: 120px;" class="text-start">Edisi</th>
                                      <td style="width: 12px;" class=" fw-bold">:</td>
                                      <td class="text-start">{{ $book->edition }}</td>
                                  </tr>
                                  <tr>
                                      <th style="width: 120px;" class="text-start">Tahun Terbit</th>
                                      <td style="width: 12px;" class=" fw-bold">:</td>
                                      <td class="text-start">{{ $book->publication_year }}</td>
                                  </tr>                                
                                  <tr>
                                      <th style="width: 120px;" class="text-start">Lokasi</th>
                                      <td style="width: 12px;" class=" fw-bold">:</td>
                                      <td class="text-start">{{ $book->cupboard->name . ", " . $book->rack->name }}</td>
                                  </tr>         
                                  <tr>
                                    <th style="width: 120px;" class="text-start">Rating</th>
                                    <td style="width: 12px;" class=" fw-bold">:</td>
                                    <td class="text-start">
                                        @php
                                  ...
                                  <tr>
                                    <th style="width: 120px;" class="text-start">Status</th>
                                    <td style="width: 12px;" class=" fw-bold">:</td>
