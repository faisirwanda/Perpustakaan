                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <form method="POST" action="{{ route('profile_super_update') }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-3">
                                        <label for="id" class="col-md-4 col-form-label text-md-end">{{ __('Nomor Induk') }}</label>
                                        <div class="col-md-8">
                                            <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" name="id" value="{{ old('id', $user->id) }}" required autocomplete="id">
                                            @error('id')
                                    ...
                                    <div class="row mb-3">
                                        <label for="class_id" class="col-md-4 col-form-label text-md-end">{{ __('Kelas') }}</label>
    
                                        <div class="col-md-8">
                                            <input type="text" name="class" id="class" class="form-control @error ('class') is-invalid @enderror" value="{{ old('class', $user->class) }}">
                                            @error('class')
                                    ...
                                    <div class="row mb-0">
                                        <div class="col-md-8 offset-md-2">
                                            {{-- <button class="btn btn-primary me-3" type="submit"> <i class="fa-regular fa-user-pen"></i>
                                                Update Profil</button>
                                            <a href="/profile-super" class="btn btn-danger"> <i class="bi bi-x-circle-fill"></i> Batal </a> --}}
                                            <button class="btn btn-success btn-md me-3" type="submit"><i class="bi bi-file-earmark"></i> Simpan</button>
                                            <a href="/super/profile-super" class="btn btn-danger"> <i class="bi bi-x-circle"></i> Batal </a>
                                        </div>
                                    </div>
                                </form>
                            </div>
