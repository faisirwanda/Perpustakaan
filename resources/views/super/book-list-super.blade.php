                ...
                <div class="card-book col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="card" style="height: 25rem;">
                        ...
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title"><a href="/super/book-detail/{{ $item->slug }}" class="text-decoration-none text-dark">{{ $item->id }}</a></h5>
                            <div class="d-flex justify-content-between">
                                {{-- <p class="card-text ">{{ $item->title }}</p> --}}
                                <p class="card-text"><a href="/super/book-detail/{{ $item->slug }}" class="text-decoration-none text-dark">{{ $item->title }}</a></p>
