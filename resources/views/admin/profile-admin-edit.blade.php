                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <form method="POST" action="{{ route('profile_admin_update') }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-0">
                                        <div class="col-md-8 offset-md-2">                
                                            ...
                                            <a href="/admin/profile-admin" class="btn btn-danger"> <i class="bi bi-x-circle"></i> Batal </a>
                                        </div>
                                    </div>
                                </form>
                            </div>
