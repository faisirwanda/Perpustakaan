...
@section('content')
    ...
    <div class="mt-5">
            ...
            <tbody>
                ...
                @foreach ($transactions as $item)
                    <tr>
                        ...
                        <td>{{ $item->book_condition ? $item->book_condition : '-'  }}</td>
                        <td>
        ...
        <div class="mt-5 d-flex justify-content-start">
            @if(request('work_id') == '')
                <a href="/export/transaction/all" class="btn btn-md btn-success me-2"><i class="bi bi-filetype-xls"></i> Cetak Semua</a>
            @else
            <a href="{{ route('transaction.exportByWorkId', ['work_id' => request('work_id')]) }}" class="btn btn-success">
